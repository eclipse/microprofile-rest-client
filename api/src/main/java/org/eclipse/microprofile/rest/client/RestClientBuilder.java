 ...
 * {@link RestClientBuilderResolver#instance()}.
 * </p>
 */
public interface RestClientBuilder extends Configurable<RestClientBuilder> {
    ...
    /**
     * Specifies the <code>ExecutorService</code> to use when invoking asynchronous Rest Client interface methods. By
     * default, the executor service used is determined by the MP Rest Client implementation runtime.
     *
     * @param executor
     ...
     * @throws IllegalArgumentException
     *             if the <code>executor</code> parameter is null.
     * @since 1.1
     */
     ...
     *             if the <code>sslContext</code> parameter is null.
     * @since 1.3
     */
     ...
     * @throws NullPointerException
     *             if the <code>trustStore</code> parameter is null.
     * @since 1.3
     */
     ...
     *            the password for the specified <code>keyStore</code>
     * @return the current builder with the key store set
     * @throws NullPointerException
     *             if the <code>keyStore</code> parameter is null.
     * @since 1.3
     */
     ...
     * @throws NullPointerException
     *             if the <code>hostnameVerifier</code> parameter is null.
     * @since 1.3
     */
     ...
     * @throws IllegalArgumentException
     *             if the <code>proxyHost</code> is null or the <code>proxyPort</code> is invalid
     ...
     *
     * @param clazz
     *            the interface that defines REST API methods for use
     * @param <T>
