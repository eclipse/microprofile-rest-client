 ...
 * this interface will be invoked to build a new <code>AsyncInvocationInterceptor</code>. This interceptor would then be
 * invoked before and after swapping threads for an asynchronous client invocation.
 *
 * The priority of this provider determines when the factory's <code>newInterceptor</code> method will be invoked - but
...
public interface AsyncInvocationInterceptorFactory {
    ...
    /**
     * Implementations of this method should return an implementation of the <code>AsyncInvocationInterceptor</code>
     * interface. The MP Rest Client implementation runtime will invoke this method, and then invoke the
     * <code>prepareContext</code> and <code>applyContext</code> methods of the returned interceptor when performing an
     * asynchronous method invocation. Null return values will be ignored.
     *
